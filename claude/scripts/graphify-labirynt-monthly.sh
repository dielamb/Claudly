#!/bin/bash
# Monthly graphify update for ~/Desktop/Labirynt
# Runs /graphify --update via headless Claude Code
# Scheduled via ~/Library/LaunchAgents/net.graphify.labirynt.plist
...
# Hardcoded PATH so claude, npx, node work under launchd (no shell rc files)
